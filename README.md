...
仓库当前共有 146 个 migration SQL 文件：88 条三位数历史迁移、41 条 2026-07
审计候选、3 条后续 2026-07 production tail、6 条 2026-08 前向迁移，以及
8 条 2026-09 前向迁移（`20260901071645` 英文脏话词条、`20260903013000`
...
`20260903070000` 站内活动通知触发器、`20260903090000` 举报处理结果与申诉
驳回的站内通知）。
