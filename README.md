...
| **私信系统** | 一对一聊天 · 置顶/免打扰 · 长按回复引用 · 快捷回复 · 已读标记 · **结构化报价(报价/接受/拒绝/还价 · 24h)** · 在线状态 + 正在输入 |
| **通知中心** | 降价提醒 · 物品售出 · 系统通知 |
...
| 014–051 | `supabase/migrations/` | 后续:图片尺寸持久化 · 限流/去重 · 广场三表 · RLS 加固 · 内容审核 · 私信视频 · **050 管理后台 RPC 锁定** · **051 结构化报价(offers 表 + make_offer/respond_to_offer RPC)** |
