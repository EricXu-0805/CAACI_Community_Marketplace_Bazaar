...
仓库当前共有 156 个 migration SQL 文件：88 条三位数历史迁移、41 条 2026-07
审计候选、3 条后续 2026-07 production tail、6 条 2026-08 前向迁移，以及
18 条 2026-09 前向迁移（其中 `20260909201600` 商品发布编号重试权限已获批准并在两环境应用；`20260910211948` 修复同用户并发写入突破限额；其余包含 `20260901071645` 英文脏话词条、`20260903013000`
