...
仓库当前共有 158 个 migration SQL 文件：88 条三位数历史迁移、41 条 2026-07
审计候选、3 条后续 2026-07 production tail、6 条 2026-08 前向迁移，以及
20 条 2026-09 前向迁移（其中 `20260914200143` 已在两环境应用，商品展示权限按语句检查；`20260912024614` 添加商品游标索引；`20260909201600` 商品发布编号重试权限已获批准并在两环境应用；`20260910211948` 修复同用户并发写入突破限额；其余包含 `20260901071645` 英文脏话词条、`20260903013000`
...
最新权限优化和容量边界见 [2026-09-14 补验](docs/audit/2026-09-14-search-followup.md)。
