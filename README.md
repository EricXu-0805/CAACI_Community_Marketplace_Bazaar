...
仓库当前共有 142 个 migration SQL 文件：88 条三位数历史迁移、41 条 2026-07
审计候选、3 条后续 2026-07 production tail、6 条 2026-08 前向迁移，以及
4 条 2026-09 前向迁移（`20260901071645` 英文脏话词条、`20260903013000`
让有过会话的商品可以被卖家删除、`20260903023000` 停用 29 个日常买卖用词、
`20260903080037` 让 record_consent 接受 2026-09-03 同意版本）。
