...
仓库当前共有 149 个 migration SQL 文件：88 条三位数历史迁移、41 条 2026-07
审计候选、3 条后续 2026-07 production tail、6 条 2026-08 前向迁移，以及
11 条 2026-09 前向迁移（`20260901071645` 英文脏话词条、`20260903013000`
...
小广告判定改成需要两个信号、`20260904090000` 给下架内容的图片开一个私有桶）。
