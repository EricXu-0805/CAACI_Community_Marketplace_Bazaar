...
const PHASE_CONTENT: Record<SemesterPhase, PhaseConfig> = {
  move_in: {
    ...
    titleZh: '新生必备',
    subtitleEn: 'Browse furniture for your dorm or apartment',
    subtitleZh: '看看适合宿舍和公寓的家具',
    category: 'furniture',
    accent: '#f59e0b',
  },
  fall_session: {
  ...
  spring_session: {
    ...
    titleZh: '春季学期',
    subtitleEn: 'Browse items for the new term',
    subtitleZh: '寻找新学期需要的物品',
    accent: '#10b981',
  },
  finals_spring: {
    phase: 'finals_spring',
  ...
  move_out: {
    ...
    titleZh: '毕业清仓',
    subtitleEn: 'Find or post furniture and electronics before moving',
    subtitleZh: '搬家前寻找或发布家具、电器',
    accent: '#ef4444',
  },
  summer: {
    phase: 'summer',
