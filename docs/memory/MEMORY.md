...
- [Backlog — Onboarding glyph clipping (audit + F1 fix shipped 2026-05-17)](backlog_onboarding_glyph_clipping.md) — F1 = line-height:1.5 on .input (chose 1.5 over audit's 1.4 for sibling consistency + 0.86px safety margin); see v3_f1_glyph_clipping_shipped.md for closeout; F5 (dead-loaded webfont family-name mismatch) remains separate orthogonal sprint
...
- [V3 F1 — Onboarding nickname input glyph clipping fix shipped 2026-05-17](v3_f1_glyph_clipping_shipped.md) — single-file 2-LOC SCSS fix at `onboarding/index.vue:209-213`; `line-height: 1.5` (over audit's 1.4 for sibling consistency + 0.86px safety margin); audit-driven belt-and-suspenders; F5 webfont anomaly still queued
